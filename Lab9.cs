...
//    protected void QuickSort(Driver[] drivers, int left, int right)
//    {
//        if (left < right)
//        {
//            int pivotIndex = Partition(drivers, left, right);
//            QuickSort(drivers, left, pivotIndex - 1);
//            QuickSort(drivers, pivotIndex + 1, right);
//        }
//    }

//    private int Partition(Driver[] drivers, int left, int right)
//    {
//        Driver pivotValue = drivers[right];
//        int pivotIndex = left;
//        for (int i = left; i < right; i++)
//        {
//            if (drivers[i].TotalScore() > pivotValue.TotalScore())
//            {
//                Swap(drivers, i, pivotIndex);
//                pivotIndex++;
//            }
//        }
//        Swap(drivers, pivotIndex, right);
//        return pivotIndex;
//    }

//    private void Swap(Driver[] drivers, int index1, int index2)
//    {
//        Driver temp = drivers[index1];
